...
MONGO_DB_DATABASE = 'leo_pre'
MONGO_DB_USER = ''
MONGO_DB_PASSWORD = ''
AMQP_VHOST = "debug"

SPUFS_IMAGE_CNF = {
    'root': '/home/meishixing/panda_media/image_pre/leo',
    'urlbase': '/'
    }
ERROR_LOG_PATH = '/alidata1/logs/error_pre/leo_api.log'
RPC_SERVER_ADDRESS = ('pre.panda_service.com', 8880)
RPC_PORT = 8880
WAREHOUSE_PORT = 8980
WAREHOUSE_RPC_ADDRESS = 'pre.warehouse.com'
TRANS_PORT = RPC_PORT
TRANS_RPC_ADDRESS = 'pre.trans.com'
SERAPH_PORT = RPC_PORT
SERAPH_RPC_ADDRESS = 'pre.seraph.com'
USOPP_PORT = RPC_PORT
USOPP_RPC_ADDRESS = 'pre.usopp.com'
...
BAADE_HOST = "http://api.pre.group.meishixing.com/"
SE_HOST='127.0.0.1'
SE_PORT=9999
